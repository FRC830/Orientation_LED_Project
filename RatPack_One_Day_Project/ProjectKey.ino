...
/*
  ...
  For this first exercise, type everything above near the `void setup(){}`
  space below as how you see it
...
// Step Three Function
  // void RainbowPattern(){
  //   static uint8_t tempHue = 0;
  //   int rainbowSpeed = 4;
  //   int rainbowCycle = 2;
  //   int hueDifference = 7; //<-- Difference between two pixels' hues
  //   for(int i = 0; i < ledcount; i++){
  //     leds[i] = CHSV(rainbowSpeed*tempHue+(rainbowCycle*hueDifference*i), 255, 255);
  //   }
  //   FastLED.show();
  //   tempHue++;
  //   delay(10);
